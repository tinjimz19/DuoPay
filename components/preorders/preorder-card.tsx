...
export function PreorderCard({
  ...
  // Un pedido cancelado no se vende, y uno ya convertido no se convierte
  // otra vez: el botón desaparece en vez de fallar al pulsarlo. La base
  // también se niega, pero un botón que no se puede pulsar explica mejor.
  ...
  return (
    <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          {preorder.image_url && (
            <a
              ...
              className="shrink-0 rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
        ...
        {/*
          El enlace va a la ficha del cliente y no a la lista de ventas:
          la lista obliga a buscar entre todas y la ficha enseña justo
          sus compras. Al convertir, el pedido se queda con el cliente
          de la venta, así que este enlace siempre tiene a dónde ir.
        */}
        {yaEsVenta ? (
          <Button
            asChild
